...
- Target Sudokura v1.3.5. The numeric version components in `version.h` remain the source of truth; packaging and workflows must derive the version from them rather than maintain independent version strings.
