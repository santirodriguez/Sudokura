...
all: sudokura
sudokura: sudokura_sdl.c $(CORE) version.h game.h geometry.h i18n.h assets/generated/window_icon.c
	$(CC) $(CPPFLAGS) $(CFLAGS) $(SDL_CFLAGS) sudokura_sdl.c $(CORE) assets/generated/window_icon.c -o $@ $(SDL_LIBS) -lm
